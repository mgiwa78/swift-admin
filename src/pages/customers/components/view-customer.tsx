...
import { useGetCustomerQuery } from "../../../redux/services/customers";
...
const ViewCustomer = (props: Props) => {
  ...
  const {
    ...
    refetch: refetchCustomerApiResponse,
    isFetching,
          ...
          <div className="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
            ...
            <div className="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
              <div className="flex gap-1.25 items-center">
                {customerApiResponse?.isVerified ? (
                  <>
                    <i className="ki-filled ki-double-check-circle text-gray-500 text-sm"></i>
                    <span className="text-gray-600">Mail Verified</span>
                  </>
                ) : (
                  <>
                    <i className="ki-filled ki-cross-circle text-danger-500 text-sm"></i>
                    <span className="text-gray-600">Unverified Mail</span>
                  </>
                )}
              </div>

              {customerApiResponse?.status && (
                <div className="flex gap-1.25 items-center">
                  {" "}
                  <Badge
      ...
      <div className="container-fixed">
        <div className="flex flex-nowrap items-center lg:items-end justify-between border-b border-b-gray-200 dark:border-b-coal-100 gap-6 mb-5 lg:mb-10">
                ...
                <div
                  className={`menu-item ${
                    ...
                    `/customers/view-customer/${customerId}`
                      ? "active"
                      : ""
                  } active border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary`}
                >
                  <Link
          ...
          <div className="flex items-center lg:pb-4 gap-2.5">
            <button
              onClick={refetchCustomerApiResponse}
              disabled={isFetching}
