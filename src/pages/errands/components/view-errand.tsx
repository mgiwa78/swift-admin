...
import { BadgeType, USER_ROLE_ENUM } from "../../../constants/enums";
import LoadingSpinner from "../../../components/common/LoadingSpinner";
import { useGetErrandQuery } from "../../../redux/services/errands";

type Props = {};

const ViewErrand = (props: Props) => {
  const { errandId } = useParams();
  const location = useLocation();
  const {
    data: errandApiResponse,
    refetch: refetchErrandApiResponse,
    isFetching,
    isError,
        ...
        <div className="container-fixed">
          <div className="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10">
            ...
            <div className="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
              {errandApiResponse?.status && (
                <div className="flex gap-1.25 items-center">
                  {" "}
                  <Badge
                    status={errandApiResponse?.status || "------"}
                    type={BadgeType.UserStatus}
                  />
                </div>
              )}
          ...
          <div className="grid">
            <div className="flex flex-nowrap items-center lg:items-end justify-between border-b border-b-gray-200 dark:border-b-coal-100 gap-6 mb-5 lg:mb-5">
              <div className="grid">
                <div className="scrollable-x-auto">
                  <div className="menu gap-3" data-menu="true">
                    <div
                      className={`menu-item ${
                        location.pathname === `/errands/${errandId}/view`
                          ? "active"
                          : ""
                      }  border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary`}
                    >
                      <Link
                        className={`menu-link gap-1.5 pb-2 lg:pb-4 px-2  `}
                        to={`/errands/${errandId}/view`}
                        tabIndex={0}
                      >
                    ...
                    <div
                      className={`menu-item ${
                        location.pathname ===
                        `/errands/${errandId}/view/requests`
                          ? "active"
                          : ""
                      }  border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary`}
                    >
                      <Link
                        className={`menu-link gap-1.5 pb-2 lg:pb-4 px-2  `}
                        to={`/errands/${errandId}/view/requests`}
                        tabIndex={0}
                      >
                        <span className="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                          Requests
                    ...
                    <div
                      className={`menu-item ${
                        location.pathname ===
                        `/errands/${errandId}/view/conversation`
                          ? "active"
                          : ""
                      }  border-b-2 border-b-transparent menu-item-active:border-b-primary menu-item-here:border-b-primary`}
                    >
                      <Link
                        className={`menu-link gap-1.5 pb-2 lg:pb-4 px-2  `}
                        to={`/errands/${errandId}/view/conversation`}
                        tabIndex={0}
                      >
                        <span className="menu-title text-nowrap font-medium text-sm text-gray-700 menu-item-active:text-primary menu-item-active:font-semibold menu-item-here:text-primary menu-item-here:font-semibold menu-item-show:text-primary menu-link-hover:text-primary">
                          Conversation
              ...
              <div className="flex items-center lg:pb-4 gap-2.5">
                <button
                  onClick={refetchErrandApiResponse}
                ...
                >
                  ...
                  <div className="dropdown-content menu-default w-full max-w-[220px]">
                    ...
                    <div className="menu-item" data-dropdown-dismiss="true">
                      <button
                        className="menu-link"
                        data-modal-toggle="#report_errand_modal"
                      >
                        <span className="menu-icon">
                          <i className="ki-filled ki-information-2"></i>
                        </span>
                        <span className="menu-title">Disable</span>
                      </button>
                    </div>
                  </div>
                </div>
